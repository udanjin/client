  ...
  return (
    <>
      ...
      <div className="relative">
        <div className="overflow-y-auto h-[65vh] font-primary">
          <button
            className="absolute top-0 left-4 bg-gray-200 dark:bg-gray-800 rounded-full p-2 text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white transition duration-300 ease-in-out"
          ...
          {orders.length > 0 ? (
            ...
            <div className="text-center font  -bold flex items-center justify-center h-[50vh]">
              No Product Added
            </div>
          )}
        </div>
        <div className="overflow-visible fixed shadow-lg bottom-0 p-4 bg-white w-screen font-primary">
          <div className="mb-6">
